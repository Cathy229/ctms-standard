...
/**
 * <p>Description: 公司级别系统控制参数查询结果 </p>
 * @author 
 * @version 1.00
 * <pre>
 * 修改记录:
 * 修改后版本    		修改人   			修改日期   		修改内容
 * 20100301.1		曾维宇			20100301		创建
 * </pre>
 */
public class GetCompanyEscpByCodeQueryItem implements Serializable {
	...
	private Double escpSubnum1;
	private Double escpSubnum2;
	private Double escpSubnum3;
	...
	public Double getEscpSubnum1() {
		return escpSubnum1;
	}
	public void setEscpSubnum1(Double escpSubnum1) {
		this.escpSubnum1 = escpSubnum1;
	}
	public Double getEscpSubnum2() {
		return escpSubnum2;
	}
	public void setEscpSubnum2(Double escpSubnum2) {
		this.escpSubnum2 = escpSubnum2;
	}
	public Double getEscpSubnum3() {
		return escpSubnum3;
	}
	public void setEscpSubnum3(Double escpSubnum3) {
	...
	public Long getEsssId() {
		return esssId;
	}
	public void setEsssId(Long esssId) {
		this.esssId = esssId;
	}
	public Long getEsssEscoId() {
		return esssEscoId;
	}
	public void setEsssEscoId(Long esssEscoId) {
		this.esssEscoId = esssEscoId;
	}
