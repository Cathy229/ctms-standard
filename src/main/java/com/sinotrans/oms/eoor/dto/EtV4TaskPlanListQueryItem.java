...
public class EtV4TaskPlanListQueryItem implements Serializable {
	...
	public Double getEttaGroupNum() {
		return ettaGroupNum;
	}
	public void setEttaGroupNum(Double ettaGroupNum) {
